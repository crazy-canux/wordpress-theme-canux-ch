...
<div class="header_center">
  ...
  <a target="_blank" href="<?php echo get_option('mytheme_logo_ad_link'); ?>">
    <img class="header_ad" src="<?php if(get_option('mytheme_logo_ad')){echo get_option('mytheme_logo_ad');}else{ echo get_bloginfo('template_url').'/images/head_canux.jpg';} ?>" />
  </a>
