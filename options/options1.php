...
购物盒子（shoppingbox）是Canux Company开发的一款能够支持在线付款的插件，本主题已经优化兼容，详情请见购物盒子的使用教程：<a target="_blank" href="http://www.canuxcheng.com">点击弹出查看</a><br />
...
<p><strong>注意，现在分类目录模板的“图片列表（大图一栏）”和“大图文列表”支持商品模式！ 内页的两个产品模板支持商品模式！</strong></p>
 ...
 <p class="tishiwenzi">当前使用的主题为免费版<a target="_blank" href="http://www.canuxcheng.com"> 查看付费版详情</a></p>
 </div>

 <div class="xiaot">

              <b class="bt">多重筛选模块功能控制【付费版功能】</b>
               <p>多重筛选模块，添加了这个模块请在菜单的“<strong>搜索菜单（搜索和标签页面显示）</strong>”中按照要求建立好菜单，教程请看：<a target="_blank" href="http://www.canuxcheng.com">Canux Company</a></p>
...
<em>选择标签并集之后，比如筛选两个标签，那么只要文章拥有其中一个标签就会显示，选择标签越多，显示文章越多，选择标签交集，比如选择2个标签，那么文章必须带有这2个标签才会显示，标签选择越多，文章显示越少</em>
 <p class="tishiwenzi">当前使用的主题为免费版，付费版可以解锁选取社区模板功能<a target="_blank" href="http://www.canuxcheng.com"> 查看付费版详情</a></p>
</p>
...
<em>主题在1.08版本增加了置顶功能，现在WordPress默认的置顶会优先显示在列表的最前面，并默认显示“推荐”字样的小图标，你可以选择显示或者不显示，如果你想要更改小图标，可以在自定义css中id为tuijian_loop的css类添加自己的样式。（默认为css类，我们为你预留了id类以覆盖。）</em>
                ...
                <div class="up">
                    ...
                    <p><a href="http://www.canuxcheng.com" target="_blank">ico是什么？ico图片制作教程</a></p>
                </div>
