  <?php
		...
		$word_t54=get_option('mytheme_word_t54');
...
<b class="bt">多语言翻译</b><br />
             ...
             <input type="text" size="30"  name="language_title" id="language_title" value="<?php echo $language_title  ?>"/  />
              ...
              <img src="<?php if($language1){ echo $language1;}else{echo get_bloginfo('template_url').'/images/chinese_canux.jpg';}  ?>" alt="language" />
           <input type="text" size="20"  name="language1" id="language1" value="<?php if($language1){ echo $language1;}else{echo get_bloginfo('template_url').'/images/chinese_canux.jpg';}  ?>"/  />
           ...
           <label  for="case2_bt">语言1的链接：</label>
             <input type="text" size="30"  name="language_link1" id="language_link1" value="<?php echo $language_link1  ?>"/  />
              ...
              <img src="<?php if($language2){ echo $language2;}else{echo get_bloginfo('template_url').'/images/english_canux.jpg';}  ?>" alt="language" />
           <input type="text" size="20"  name="language2" id="language2" value="<?php if($language2){ echo $language2;}else{echo get_bloginfo('template_url').'/images/english_canux.jpg';}  ?>"/  />
            <input type="button" name="upload_button" value="上传" id="upbottom"/>
...
<b class="bt">翻译</b><br />
 <p>对照左边的中文，你可以吧这些固定的词语替换成你想要的，如果你不是多语言网站，也可以使用这个功能改变你想要改变的文字。</p>
       ...
       <p> <label  for="word_t54">搜索（多重筛选）：</label>
     <input type="text" size="20"  name="word_t54" id="word_t54" value="<?php if($word_t54!=""){echo $word_t54;}else{echo '搜索';}  ?>"/  />
   </p>
